...
class mainController
{
	...
	function sqlQueries()
	{
		...
		$array[1] = "INSERT INTO tbl_questions(question, options, answer, score, question_code)VALUES('".$this->question."', '".$this->options."', '".$this->answer."', '".$this->score."', '".$this->generateRandomCode()."')";
